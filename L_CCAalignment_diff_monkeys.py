...
def processData(neural_file, dest_dir, latents_path):
...
def plot_fig_CCA(CCAdata_days, gs, full_data, date0, datek):
    ...
    fig1.suptitle(f'CCA Alignment of Monkey0 ({date0}) and Monkey1 ({datek})')

    titles=[f'Monkey0 unaligned',f'Monkey0 unaligned',
            f'Monkey1 unaligned',f'Monkey1 unaligned', 
            f'Monkey0 aligned',f'Monkey0 unaligned',
            f'Monkey1 aligned',f'Monkey1 unaligned',
            ]
...
def plot_dims_CCA(CCAdata_days, min_time, full_data, date0, datek):
    ...
    for _, direction in zip(   
        ...
        fig.suptitle(f"Neural Modes of Monkey0 ({date0}) and Monkey1 ({datek}) - Direction: {direction}", fontsize=11)
        axes=[]
        ...
        for dim in range(n_components):
            ...
            ax.plot(time_bins, unaligned_trials0[5:,dim], color=color[0],lw=1, marker='o', label='Unaligned Monkey0')
            ax.plot(time_bins, unaligned_trialsk[5:,dim], color=color[1],lw=1, marker='o', label='Unaligned Monkey1')
            ax.plot(time_bins, aligned_trials0[5:,dim], color=color[2],lw=1, marker='x', label='Aligned Monkey0')
            ax.plot(time_bins, aligned_trialsk[5:,dim], color=color[3],lw=1, marker='x', label='Aligned Monkey1')
...
def plot_graph_CCA(D_CCAdata_days, CCAdata_days,  data_aligned, n_components, date0, datek):
    ...
    fig.suptitle(f'Canonical Correlation of each Neural Mode - Monkey0 ({date0}) and Monkey1 ({datek})', fontsize=11)

    x_ = np.arange(1,n_components+1)
    ax.plot(x_, allCCs_aligned, color='green', marker = 'o', label=f'Comparing Monkey0 and Monkey1 (Aligned)')
    ax.plot(x_, allCCs, color='red', marker = 'o', label=f'Comparing Monkey0 and Monkey1 (Unaligned)')
    ax.plot(x_, CCsU[0, :], color='lightblue', marker = '<', ls='--', label=f'Comparing within Monkey0')
    ax.plot(x_, CCsU[1, :], color='darkblue', marker = '<', ls='--', label=f'Comparing within Monkey1')
...
if __name__ == "__main__":
    ...
    #DATA
    #Typical data:
    # neural_day0_path=r"c:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\navtrainingsphere_Vino_20240116_0939_C_trials.pkl"
    # neural_day1_path=r"c:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\navtrainingsphere_Vino_20240830_0921_B_trials.pkl"
    # neural_day2_path= r"c:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\navtrainingsphere_Vino_20240904_1006_B_trials.pkl"
    # neural_day3_path= r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\navtrainingsphere_Vino_20240906_0931_A_trials.pkl"

    #Other data:
    #neural_file= r"c:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\navtrainingsphere_Vino_20240116_0939_C_trials.pkl"
    #neural_file= r"c:\GBW_MyDownloads\Code\Data\navtrainingsphere_vino_20240117_1016_b_cer1005-ccf_2024-10-30_1424\navtrainingsphere_Vino_20240118_1041_B_trials.pkl"
    #neural_file= r"c:\GBW_MyDownloads\Code\Data\navtrainingsphere_vino_20240117_1016_b_cer1005-ccf_2024-10-30_1424\navtrainingsphere_Vino_20240119_1033_C_trials.pkl"


    #LATENT VARIABLES
    #only spikes
    dest_dir = r"C:\GBW_MyDownloads\Code\Decoding_algorithm\Models"
    # latents_day0_path = r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\latents_spikes - day0_20240116_0939.pkl"
    # latents_day1_path = r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\latents_spikes - day1_20240830.pkl"
    # latents_day2_path = r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\latents_spikes - day2_20240904.pkl"
    # latents_day3_path= r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\latents_spikes - day3_20240906.pkl"

    #spikes+LFPs - PSID
    # latents_day0_path = r"c:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\latents_spikes+LFPs - day0_20240116_Clean.pkl"
    # latents_day0_path = r"c:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\latents_spikes+LFPs - day0_20240116_0939.pkl"
    # latents_day1_path= r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\latents_spikes+LFPs - day1_20240830_Cleaner.pkl"
    # latents_day1_path= r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\latents_spikes+LFPs - day1_20240830.pkl"
    # latents_day2_path = r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\latents_spikes+LFPs - day2_20240904.pkl"
    # latents_day3_path= r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\latents_spikes+LFPs - day3_20240906.pkl"

    #spikes+LFPs - PCA
    # latents_day0_path= r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\PCA_latents_SL_20240116.pkl"
    # latents_day1_path= r"c:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\PCA_latents_SL_20240830.pkl"
    # latents_day2_path= r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\PCA_latents_SL_20240904.pkl"
    # latents_day3_path= r"C:\GBW_MyDownloads\Code\Data\navdecodingsphere_vino_20240906_0939_a_trials-pkl_2024-10-03_1211_LFPs\PCA_latents_SL_20240906.pkl"
    ...
    latents_day0_path= r"C:\GBW_MyDownloads\Code\0N_Data\navigation\navtrainingsphere_Maui_20241112_0950_A\latents.pkl"
    latents_day1_path= r"C:\GBW_MyDownloads\Code\0N_Data\navigation\navtrainingsphere_Maui_20241113_0948_A\latents.pkl"
    latents_day2_path= r"C:\GBW_MyDownloads\Code\0N_Data\navigation\navtrainingsphere_Maui_20241118_1002_A\latents.pkl"
    ...
    neural_file = {
        ...
        'Day1': neural_diffmonkey_path #neural_diffmonkey_path
    }

    latents_paths = {
        'Day0': latents_day08_path,
        'Day1': latents_diffmonkey_path #diffmonkey_path
    }
    ...
    # full_data['Day0']['Left']
    for day in days:
        left_trials, right_trials, straight_trials = processData(neural_file[day], dest_dir, latents_paths[day])
        ...
        # min_trials, min_time,_ = np.min((left_trials,right_trials.len, straight_trials.shape),axis=0)
        # left_trials=left_trials[:min_trials,:min_time,:]
        # right_trials=right_trials[:min_trials,:min_time,:]
        # straight_trials=straight_trials[:min_trials,:min_time,:]
        # day_data[day]= np.array([left_trials, right_trials, straight_trials])
