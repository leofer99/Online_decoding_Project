...
# In this code, I align the Day0 mean_trial with the DayK mean_trial 
##############################################
...
def full_process(neural_file_0, neural_file_k, targets_day0_path, targets_dayk_path):
    ...
    CCA_ = CCA_coefficients(latents_0, latents_k, targets_0, targets_k)
...
_, directions_sim_day0_00 = full_process(neural_file_0, neural_file_0, targets_day0_path, targets_day0_path) #Day0 with itself 
fig_01, directions_sim_day0_01 = full_process(neural_file_0, neural_file_1, targets_day0_path, targets_day1_path)
...
# fig_03, directions_sim_day0_03 = full_process(neural_file_0, neural_file_3, targets_day0_path, targets_day3_path) 
# fig_05, directions_sim_day0_05 = full_process(neural_file_0, neural_file_5, targets_day0_path, targets_day5_path) 
fig_06, directions_sim_day0_06 = full_process(neural_file_0, neural_file_6, targets_day0_path, targets_DIFMONKEY_day6_path) #Day0 with a DayK
