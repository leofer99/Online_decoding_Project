...
CCA={'Offline': True}
Kalman_latents= True #can make it true, to test the latents obtained with the Kalman values
...
latents_0 = process_latents(neural_file0, Kalman_latents) #training file
latents_k = process_latents(neural_filek, Kalman_latents) #training file
