...
def process_Kalman_latents(neural_file):
...
CCA={'Offline': True}
Kalman_latents= False #can make it true, to test the latents obtained with the Kalman values
...
neural_file0 = neural_file_list[0] #using 0
neural_filek = neural_file_list[4] #using 4
...
kalman_latents_k = process_Kalman_latents(neural_filek) #for testing 
...
if split:
    ...
    _, kalman_latents_k_test = train_test_split(kalman_latents_k, test_size=test_size, random_state=random_state)
    ...
    kalman_latents_k_test=kalman_latents_k
...
#TEST
latents_sim0_canonical, latents_simk_canonical= apply_CCA(CCA_, latents0_test, kalman_latents_k_test)
...
if test_size==0:
    ...
    trial_indexes = [0, 3, 5, 6, 7, 10, 13, 14, 15, 16]  
elif test_size==0.5:
